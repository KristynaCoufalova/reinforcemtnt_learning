...
parser.add_argument("--evaluate", default=False, action="store_true", help="Evaluate the given model") #if I say evaluate True, I already have a model and I want to evaluate it 
